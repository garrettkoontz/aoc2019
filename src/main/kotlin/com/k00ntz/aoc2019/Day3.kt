...
fun traceWire(paths: List<ManhattanDirection>): List<Point> {
...
fun findClosestIntersection(path1: List<ManhattanDirection>, path2: List<ManhattanDirection>): Int {
...
fun findFirstIntersection(path1: List<ManhattanDirection>, path2: List<ManhattanDirection>): Int {
