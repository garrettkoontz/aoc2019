...
//        assertEquals(
//            "24176176",
//            day16.phase("80871224585914546619083218645595".toCharArray().map { it - '0'}, 100).take(8).joinToString(
//                separator = ""
//            )
//        )
//        assertEquals(
//            "73745418",
//            day16.phase("19617804207202209144916044189917".toCharArray().map { it - '0' }, 100).take(8).joinToString(
//                separator = ""
//            )
//        )
//        assertEquals(
//            "52432133",
//            day16.phase("69317163492948606335995924319873".toCharArray().map { it - '0' }, 100).take(8).joinToString(
//                separator = ""
//            )
//        )
//    }
...
//    @Test
//    fun part2() {
//        assertEquals("84462026", day16.part2("03036732577212944063491565474664".toCharArray().map { it - '0' }))
//        assertEquals("78725270", day16.part2("02935109699940807407585447034323".toCharArray().map { it - '0' }))
//        assertEquals("53553731", day16.part2("03081770884921959731165446850517".toCharArray().map { it - '0' }))
//    }
